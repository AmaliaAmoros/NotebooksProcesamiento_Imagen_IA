# -*- coding: utf-8 -*-
"""Actividad_2_IA_AmaliaYÁngela_Parte1

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1nFetxNGqRcFVzsHVp-_uKb4k1fMyQOtg

#ACTIVIDAD 2. Detección de objetos con Deep Learning
##Parte 1: Hacer funcionar el código
...
"""Hemos cambiado los directorios que venían en el código original por los nuestros para copiarlos en una carpeta común."""
...
"""Hemos cambiado el directorio original por nuestro directorio que nos llevaria a las imágenes de train.
...
"""Hemos eliminado del código original todo lo relacionado con evaluar el modelo porque no nos interesa evaluarlo para nuestro objetivo.
...
"""
Obtenemos la inferencia del modelo de detección de objetos en un conjunto de datos de prueba y se muestran las visualizaciones de las imágenes procesadas.

Tenemos un total de 19 imágenes en el conjunto de datos de prueba y 9.746 es el FPS promedio calculado durante la ejecución del código. Además, para cada imagen con al menos una detección, se muestra una visualización con las cajas delimitadoras dibujadas, etiquetas de clase ("Label"). Debería aparecer la etiqueta de clase "Crater" también y el valor de confianza asociado. Como no aparecen puede deberse a que el umbral de confianza (detection_threshold) es demasiado alto y las detecciones con confianza inferior al umbral no se pueden mostrar."""